Feature: OBJ Parser
    ...
    Scenario: Triangulating polygons
        Given file = a file containing:
          ...
          Then t1.p1 = parser.vertices[1]
          Then t1.p2 = parser.vertices[2]
          Then t1.p3 = parser.vertices[3]
          Then t2.p1 = parser.vertices[1]
          Then t2.p2 = parser.vertices[3]
          Then t2.p3 = parser.vertices[4]
          Then t3.p1 = parser.vertices[1]
          Then t3.p2 = parser.vertices[4]
           And t3.p3 = parser.vertices[5]

    Scenario: Triangles in groups
        Given file = the file "triangles.obj"
         When parser = parse_obj_file(triangles)
