Feature: Tuples, Vectors, and Points
    ...
    Scenario: point() creates tuples with w=1
        Given point(4.0, -4.0, 3.0)
         Then p = tuple(4.0, -4.0, 3.0, 1.0)

    Scenario: vector() creates tuples with w=0
        Given vector(4.0, -4.0, 3.0)
    ...
    Scenario: Subtracting a vector from the zero vector
        Given v1 = vector(0.0, 0.0, 0.0)
          And v2 = vector(1.0, -2.0, 3.0)
         Then v1 - v2 = vector(-1.0, 2.0, -3.0)
    ...
    Scenario: Computing the magnitude of vector(1, 2, 3)
        Given v = vector(1.0, 2.0, 3.0)
         Then magnitude(v) = ‭3.741657386773941‬
    ...
    Scenario: The dot product of two tuples
        Given v1 = vector(1.0, 2.0, 3.0)
          And v2 = vector(2.0, 3.0, 4.0)
         Then dot(v1, v2) = 20

    Scenario: The cross product of two vectors
        Given v1 = vector(1.0, 2.0, 3.0)
          And v2 = vector(2.0, 3.0, 4.0)
         Then cross(v1, v2) = vector(-1.0, 2.0, -1.0)
          And cross(v2, v1) = vector(1.0, -2.0, 1.0)
